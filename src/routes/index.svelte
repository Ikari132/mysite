...
<section>
  <div class="row my-5 d-flex flex-sm-row flex-column-reverse">
    <div
      class="col-sm-6 col-12 d-flex flex-column justify-content-between about"
    >
      <div>
      ...
      <div class="row py-3 contacts-row">
        <div
          class="col d-flex justify-content-center justify-content-sm-start gap-2"
        >
          <div class="contact">
            <a
    ...
    <div
      class="col-sm-6 col-12 d-flex justify-content-center justify-content-sm-end"
    >
